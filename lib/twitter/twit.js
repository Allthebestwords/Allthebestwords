  ...
  dataStream.on('tweet', async(tweet) => { 
    if(tweet.user.id_str === targetUser){
      ...
      if(foundState) {
        ...
        const params = { status: `@${tweet.user.screen_name} We were unable to process your request. Please reply with your state name.`, in_reply_to_status_id: tweet.id_str };
